...
function calculateSupply(age,amountPerDay)
{
  ...
  const message = `You will need ${totalAmount} cups of tea to last you until the ripe old age of ${maxAge}.`;
  return message;
}
*/
/* 4
...
x undeclern u have to change it to cat

function double(7) {
  return 2 * 7;
}
argument 7 must change to  string cant be int

function double('7') {
  return 2 * 'x';
}
same as before the argument and the x
*/
...
*/
 ...
 {
  var calCube =number*number*number;
  return calCube;
 }
...
function average(num1,num2,num3,num4,num5)
{
  ...
  // i know how to do it by for loop
  return avg;
}
...
function resetCounter() 
{
  ...
  return function () 
  {
    ...
    count = 0;
    return `${beforeReset} and the counter reset now`;
  };
}
